namespace Be.Vlaanderen.Basisregisters.ProjectionHandling.Connector
{
    ...
    public abstract class ConnectedProjection<TConnection> : IEnumerable<ConnectedProjectionHandler<TConnection>>
    {
        ...
        /// </summary>
        protected ConnectedProjection() => _handlers = new List<ConnectedProjectionHandler<TConnection>>();
        ...
        /// </value>
        public ConnectedProjectionHandler<TConnection>[] Handlers => _handlers.ToArray();
        ...
        /// </returns>
        public static implicit operator ConnectedProjectionHandler<TConnection>[] (ConnectedProjection<TConnection> instance) => instance.Handlers;
