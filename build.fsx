...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.ProjectionHandling")
...
Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.ProjectionHandling")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.ProjectionHandling")
