...
Target.create "Lib_Build" (fun _ ->
  ...
  buildSource "Be.Vlaanderen.Basisregisters.ProjectionHandling.Runner.SqlServer"
  buildSource "Be.Vlaanderen.Basisregisters.ProjectionHandling.Runner.Npgsql"
...
Target.create "Lib_Publish" (fun _ ->
  ...
  publishSource "Be.Vlaanderen.Basisregisters.ProjectionHandling.Runner.SqlServer"
  publishSource "Be.Vlaanderen.Basisregisters.ProjectionHandling.Runner.Npgsql"
