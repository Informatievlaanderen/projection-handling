namespace Be.Vlaanderen.Basisregisters.ProjectionHandling.Connector.Tests.Testing
{
    using System;
    ...
    namespace ConnectedProjectionScenarioTests
    {
        [TestFixture]
        public class AnyState
        {
            ...
            public void ResolverCanNotBeNull()
            {
                Assert.Throws<ArgumentNullException>(
                    () => new ConnectedProjectionScenario<object>(null));
            }
        ...
        {
            private ConnectedProjectionHandlerResolver<object> _resolver;
            private ConnectedProjectionScenario<object> _sut;
        ...
        {
            public static ConnectedProjectionScenario<TConnection> Create<TConnection>()
            {
                return new ConnectedProjectionScenario<TConnection>(
                    Resolve.WhenEqualToHandlerMessageType(new ConnectedProjectionHandler<TConnection>[0]));
            }
