namespace Be.Vlaanderen.Basisregisters.ProjectionHandling.Connector.Tests
{
    ...
    public class ConnectedProjectionHandlerEnumeratorTests
    {
        ...
        [TestCaseSource(nameof(MoveNextCases))]
        ...
        [TestCaseSource(nameof(MoveNextAfterResetCases))]
        ...
        [TestCaseSource(nameof(ResetCases))]
        ...
        [TestCaseSource(nameof(CurrentNotStartedCases))]
        ...
        [TestCaseSource(nameof(CurrentCompletedCases))]
        ...
        [TestCaseSource(nameof(CurrentStartedCases))]
