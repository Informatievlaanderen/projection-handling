namespace Be.Vlaanderen.Basisregisters.ProjectionHandling.Connector.Tests.ConnectedProjectionTests
{
    using System;
    ...
    {
        private class Any : ConnectedProjection<object>
        {
        }
    ...
    {
        private class WithoutHandlers : ConnectedProjection<object>
        {
        }
    ...
    {
        private class WithHandlers : ConnectedProjection<object>
        {
